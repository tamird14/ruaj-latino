  ...
  return (
    ...
    >
      ...
      <div className="aspect-square bg-dark-800/80 rounded-lg mb-3 flex items-center justify-center overflow-hidden relative ring-1 ring-dark-700/70">
        ...
        <button
          onClick={handlePlay}
          className="absolute bottom-2 right-2 w-11 h-11 bg-primary-500 rounded-full flex items-center justify-center opacity-100 md:opacity-0 md:group-hover:opacity-100 translate-y-0 md:translate-y-2 md:group-hover:translate-y-0 transition-all shadow-lg shadow-primary-500/25 hover:scale-105"
        >
